...
/***/ "./node_modules/css-loader/dist/cjs.js!./resources/css/main.css":
/*!**********************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./resources/css/main.css ***!
  \**********************************************************************/
...
`, "",{"version":3,"sources":["webpack://./resources/css/main.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;AACA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;AACA;IACI,aAAa;IACb,YAAY;IACZ,cAAc;IACd,sBAAsB;AAC1B;AACA;IACI,aAAa;IACb,YAAY;IACZ,sBAAsB;IACtB,cAAc;IACd,sBAAsB;AAC1B;AACA;IACI,sBAAsB;AAC1B","sourcesContent":["* {\r\n    margin: 0;\r\n    padding: 0;\r\n    box-sizing: border-box;\r\n}\r\nbody {\r\n    display: flex;\r\n    justify-content: center;\r\n    align-items: center;\r\n}\r\nhtml, body {\r\n    height: 100vh;\r\n    width: 100vw;\r\n    overflow: clip;\r\n    background-color: grey;\r\n}\r\n.gameFieldDiv {\r\n    height: 100vh;\r\n    width: 100vw;\r\n    background-color: grey;\r\n    flex-shrink: 0;\r\n    box-sizing: border-box;\r\n}\r\n#gameFieldCanvas{\r\n    background-color: grey;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./resources/html_templates/partials/game_field.hbs":
/*!**********************************************************!*\
  !*** ./resources/html_templates/partials/game_field.hbs ***!
  \**********************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_main_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./main.css */ "./node_modules/css-loader/dist/cjs.js!./resources/css/main.css");
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./print */ "./src/main/print.ts");
/* harmony import */ var _resources_css_main_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../resources/css/main.css */ "./resources/css/main.css");
/* harmony import */ var _wallpaper_engine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wallpaper_engine */ "./src/main/wallpaper_engine.ts");
 // for testing webpck


let gamefield_template = __webpack_require__(/*! ../../resources/html_templates/partials/game_field.hbs */ "./resources/html_templates/partials/game_field.hbs");
let uiWorker = null;
function initMissingUiWorker() {
    if (uiWorker == null) {
        uiWorker = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("src_workers_canvas_worker_ts"), __webpack_require__.b));
    }
    return uiWorker;
}
function startWindowWorker(canvas, canvas2) {
    let offscreenCanvas = undefined;
    let offscreenCanvas2 = undefined;
...
function mouseListening(event) {
    uiWorker === null || uiWorker === void 0 ? void 0 : uiWorker.postMessage({ message: "mouseposition", xPos: event.pageX, yPos: event.pageY });
}
function create_missing_html_canvas_on_gamefield() {
    let gameSpace = document.getElementById("gameField");
    if (gameSpace == null) {
        console.error("couldn't find the gameField");
    }
    let canvas = (document.getElementById("gameFieldCanvas"));
    if (canvas == null) {
        canvas = document.createElement("canvas");
        canvas.id = "gameFieldCanvas";
        gameSpace === null || gameSpace === void 0 ? void 0 : gameSpace.appendChild(canvas);
    }
    return canvas;
}
...
(() => {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        (0,_wallpaper_engine__WEBPACK_IMPORTED_MODULE_2__.add_wallpaper_engine_audio_listening)();
        (0,_wallpaper_engine__WEBPACK_IMPORTED_MODULE_2__.set_ui_worker)(uiWorker);
